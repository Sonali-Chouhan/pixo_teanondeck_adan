        ...
        return (
            <div class="relative">
                <input
                    ...
                    type="search"
                    className="pl-10 pr-4 py-2 border border-gray-400 rounded-full font-poppins text-[#A29EB6]"
                    placeholder="Search" />
    ...
    return (
        <>
            <div className="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12">
                ...
                <Tooltip anchorSelect=".Slip" place="top" >Download Slip</Tooltip>
                <Tooltip anchorSelect=".Report" place="top" >Download Report</Tooltip>
                <Tooltip anchorSelect=".Salary" place="bottom-start" >Calculate Salary</Tooltip>
                <button className={isVerify ? "col-span-1 bg-purple-700 text-white Slip m-1 mt-4 h-10 text-center font-poppins text-[#A29EB6]  text-sm rounded-full border border-gray-400 focus:ring-4 font-medium" :
                    "col-span-1 Slip m-1 mt-4 h-10 text-center font-poppins text-[#A29EB6]  text-sm rounded-full border border-gray-400 focus:ring-4 font-medium"}>
                    <i class="fa fa-download" aria-hidden="true"></i>&nbsp; Slip
                </button>
                <button className={isVerify ? "col-span-1 bg-purple-700 text-white Report m-1 mt-4 h-10 text-center font-poppins text-[#A29EB6] text-sm rounded-full border border-gray-400 focus:ring-4 font-medium"
                    : "col-span-1 Report m-1 mt-4 h-10 text-center font-poppins text-[#A29EB6] text-sm rounded-full border border-gray-400 focus:ring-4 font-medium"}>
                    <i class="fa fa-download" aria-hidden="true"></i>&nbsp; Report
                </button>
                <button className={isVerify ? "col-span-1 bg-purple-700 text-white m-1 mt-4 Salary h-10 text-center font-poppins text-[#A29EB6] text-sm rounded-full border border-gray-400 focus:ring-4 font-medium"
                    : "col-span-1 m-1 mt-4 Salary h-10 text-center font-poppins text-[#A29EB6] text-sm rounded-full border border-gray-400 focus:ring-4 font-medium"}
                    onClick={verifySalaryhandler}>
                    <i class="fa fa-calculator" aria-hidden="true"></i>&nbsp; Salary
                </button>
            </div>
