...
const AddUpdateHoliday = (props) => {

    return (
        <>
            <Modal show={props.isOpen} size={'xl'} position="center" onClose={() => props.setOpenModal(false)}>
                <Modal.Header>{props.update ? "Update Holiday" : "Add Holiday"}</Modal.Header>
                <Modal.Body>
                    <div className="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 bg-white">
                        <div className=" lg:col-span-12 md:col-span-12 sm:col-span-12 text-center">
                            <TextInput
                                showLabel={false}
                                defaultValue={props?.update?.holiday ? props.update.holiday : ""}
                                type="text"
                                label="Holiday"
                                name="holiday"
                                id="holiday"
                        ...
                        <div className=" lg:col-span-12 md:col-span-12 sm:col-span-12 text-center mt-1">
                            <DatePicker
                                showLabel={false}
                                defaultValue={props?.update?.date ? props.update.date : ""}
                                label="Date"
                                name="date"
                                id="date"
                                placeholder="Date"
